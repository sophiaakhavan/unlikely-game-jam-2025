// Copied from TMP_Bitmap shader

Shader "Custom/BitmapTextStencil" {

Properties {
	[HideInInspector] _MainTex ("Font Atlas", 2D) = "white" {}
	[HideInInspector] _FaceTex ("Font Texture", 2D) = "white" {}
	[HideInInspector] [HDR]_FaceColor	("Text Color", Color) = (1,1,1,1)
