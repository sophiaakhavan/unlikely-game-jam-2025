// Copied from TMP_SDF-Mobile shader

Shader "Custom/TextStencil" {

Properties {
	[HideInInspector] [HDR]_FaceColor ("Face Color", Color) = (1,1,1,1)
	...
	[HideInInspector] [HDR]_UnderlayColor ("Border Color", Color) = (0,0,0,.5)
